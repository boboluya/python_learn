...
# 加载模型
model = tf.keras.models.load_model("face_get22.keras")
...
# 转为整数坐标
x, y, w, h = [i for i in y_pred]

# 在彩色图上画框
# cv2.rectangle(img_color, (x, y), (x + w, y + h), (0, 255, 0), 2)
img_color = rz.revertimg(r"C:\Users\bobol\Desktop\CNN\faces\train\0--Parade\0_Parade_marchingband_1_796.jpg",[x, y, w, h],[256, 256])
